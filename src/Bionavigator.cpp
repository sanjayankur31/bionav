...
Bionavigator::Bionavigator ()
{
    ...
    mpPlaceCells_HD_VelocitySynapseSet = new PlaceCells_HD_VelocitySynapseSet ();
 ...
 */
    ...
    /*  Finally normalize */
    mpPlaceCells_HD_VelocitySynapseSet->Normalize ();
    ...
    mpPlaceCells_HD_VelocitySynapseSet->LearningRate (0.0);
