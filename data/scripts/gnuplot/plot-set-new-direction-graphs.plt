...
set out
set terminal postscript eps enhanced color font "Helvetica,20" linewidth 2 
set output "250.000000-Forced-activation.eps"
set xlabel "Head direction cells"
set ylabel "Activation"
set title ""
plot "./250.000000-Forced-HDCells-Activation-0.txt" with lines title "At time 0", "./250.000000-Forced-HDCells-Activation-9.txt" with lines title "At time 10", "./250.000000-Forced-HDCells-Activation-19.txt" with lines title "At time 20", "./250.000000-Forced-HDCells-Activation-29.txt" with lines title "At time 30", "./250.000000-Forced-HDCells-Activation-39.txt" with lines title "At time 40", "./250.000000-Forced-HDCells-Activation-49.txt" with lines title "At time 50"
set term wxt
set out
set terminal postscript eps enhanced color font "Helvetica,20" linewidth 2 
set output "250.000000-Forced-firing-rates.eps"
set xlabel "Head direction cells"
set ylabel "Firing rate"
set title ""
plot "./250.000000-Forced-HDCells-FiringRate-0.txt" with lines title "At time 0", "./250.000000-Forced-HDCells-FiringRate-9.txt" with lines title "At time 10", "./250.000000-Forced-HDCells-FiringRate-19.txt" with lines title "At time 20", "./250.000000-Forced-HDCells-FiringRate-29.txt" with lines title "At time 30", "./250.000000-Forced-HDCells-FiringRate-39.txt" with lines title "At time 40", "./250.000000-Forced-HDCells-FiringRate-49.txt" with lines title "At time 50"
